...
public class MM_OpenCVLoader
{
    ...
    {
        return MM_StaticHelper.initOpenCV(false);
    }

    /**
     * Loads and initializes OpenCV library from current application package. Should only initialize the main library, core, and imgproc.
     * @return Returns true is initialization of OpenCV was successful.
     */
    public static boolean initImgprocOnly(){
        return MM_StaticHelper.initImgprocOnly();
    }
